import cv2
import os  # The os library provides general common operations for directories and files
import shutil  # The shutil library supplements os, providing copy, move, delete, compression, and decompression operations
import numpy as np
...
if __name__ == '__main__':
    ...
    same_thres = 0.9  # Threshold for isotropy; if the proportion of identical points exceeds 0.9, it is considered isotropic
    ...
    for file_name in os.listdir(input_dir):  # Iterate over files in the folder
        ...
        # blur = cv2.medianBlur(img, 3)  # Not suitable for straight lines or rectangles
        ...
        # labels: label for each pixel (1, 2, 3, ...), same component has the same label
